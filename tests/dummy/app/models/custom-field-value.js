...
/**
 * Minimal stand-in for the `custom-field-value` model, which real host applications
 ...
 *
 * Deliberately thin: nothing in this suite asserts `custom-field-value` behaviour, only
